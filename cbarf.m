%This function was obtained from the MATLAB support community and produces
%a contoured colorbar for the output images of the main script. I have
%decided not to add any additional comments to this script as there is
...
if isVertical
  yt=L(a:b+1);
  %{
  %This portion of code was originally in place when I downloaded it, but
  %it seems to suppress the tick labels when there are greater than 10 
  %bins. This change seems to have rectified it.
  yt=get(ax,'ytick');
