%This function calculates the methane solubility in water as a function of
%pressure, temperature, and salinity of the brine.
...
%Outputs:
%   molality = methane solubility (kg CH4/kg solution)

function molality=methane_solubility(P,T,x);
...
molality=P/exp(par+2*lambda_par*x+xi_par*x^2-log(fugacity_coef));
